...
class ModelGenerator:
    ...
    PARAMETERS
    ----------
    model : The Keras model or a callable function that generates the model.
...
class DeepEnsemble:
    ...
    sampler : An optional bootstrapping sampler for generating training samples.
    ...
    def fit(self,
        ...
        **tfkwargs : Additional Keras keyword arguments to pass to the
                    model.fit() call.
